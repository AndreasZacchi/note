function getAllTable(path) {
    $(document).ready(function () {
        ...
        $("#newContainer").append('<a title="New Note" href="#" onclick="newNote(\'' + path +'\');"><i class="fa fa-file-text buttonNote" aria-hidden="true"></i></a>');
        $("#newContainer1").append('<a title="New Folder" href="#" onclick="newFolder(\'' + path + '\');"><i class="fas fa-folder-plus buttonNote"></i></a>');
